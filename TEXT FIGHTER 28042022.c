...
int ctr = 0, ctr2 = 0, playerhp = 5, enemyhp = 5, contest = 0, consecvic = 0, consecvic2 = 0, consectr = 0, spctrbon = 0, ctrbonon = 0, ctrbondef = 0, consecvic3 = 0, spctrbon2 = 0, diceQ2 = 0, g2 = 0, sumag10 = 0;
int spatt = 0, supspatt = 0, hypsp = 0, enspcomb1 = 0, enspcomb2 = 0, enspcomb3 = 0, c = 0, d = 0, e = 0, f = 0, g = 0, cpmag = 0, cpmag2 = 0, c2 = 0, diceS1 = 0, diceS2 = 0, diceS3 = 0;
int spmag = 0, spmag2 = 0, magsp = 0, magsp2 = 0, normag = 0, magsp3 = 0, sumag2 = 0, sumag = 0, magsp7 = 0, consecvic5 = 0, consecvic7 = 0, spctrbon7 = 0, spdup = 0, supdup = 0, supdup2 = 0, e2 = 0, rebon = 0;
int diflev = 0, posdef = 0, posmag = 0, posbon = 0, bonchn = 0, bonchn2 = 0, cpusp = 0, cpusp2 = 0, consecvic4 = 0, spctrbon3 = 0, ultsp = 0, ultsp3 = 0, ultsp4 = 0, ultdup = 0, magdup = 0, magdup2 = 0, magchn10 = 0;
int ans6 = 1, sumag5 = 0, spmag5 = 0, spmag6 = 0, magchn = 0, posmag2 = 0, cpusp3 = 0, spctrdf = 0, mspatt = 0, emgspcom = 0, mspatt2 = 0, emgspcom2 = 0, emgsupatt = 0, emagsup = 0, bonchn5 = 0;
int mspatt3 = 0, emgspcom3 = 0, hypsp2 = 0, spatt2 = 0, supspatt2 = 0, emgspcom4 = 0, mspatt4 = 0, new0 = 1, bonrec5 = 0, dmg = 0, dmg2 = 1, a = 0, b = 0, magdup3 = 0, magdup4 = 0, h = 0,  i = 0, bonchn7 = 0;
int emgspcom5 = 0, emagsup5 = 0, mspatt5 = 0, bonrec = 0, magrec = 0, bonrec2 = 0, magrec2 = 0, spmag3 = 0, fghton = 0, fghton2 = 0, new9 = 0, wnct8 = 0, cpuwn8 = 0, magsp4 = 0, f2 = 0, magchn5 = 0;
int wnct = 0, cpuwn = 0, wnct2 = 0, wnctrec = 0, new1 = 0, new2 = 0, new3 = 0, new4 = 0, new5 = 0, new6 = 0, cpuwnct = 0, cpuwn2 = 0, new7 = 0, cpuwn3 = 0, wnct3 = 0, new10 = 0, new8 = 0, d2 = 0, cnclbn = 0;
int cpuwn4 = 0, wnct4 = 0, cpuwn5 = 0, wnct5 = 0, wnct6 = 0, cpuwn6 = 0, spoff = 0, spoff2 = 0, emgspcom7 = 0, enspcomb1b = 0, enspcomb2b = 0, enspcomb3b = 0, mgoff = 0, mspatt8 = 0, magcom = 0, sumag4 = 0;
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, hypsp3 = 0, wnctrecA = 0, prntcor = 0, dubon = 0, cpwncop = 0, sumag3 = 0;
float wnrt = 0, wnrtrec = 0, torwnrt = 0, torwnrt2 = 0, torwnrt3 = 0, wnrt2 = 0, wnrtrec2 = 0, wnrtrec3 = 0, wnrtrec4 = 0, wnrtrec5 = 0, wnrt3 = 0, wnrt6 = 0, wnrt5 = 0, cpuwnrt = 0, cpuwnrt2 = 0, spmag7 = 0;
time_t t;
...
if ((diflev > 1) && (dmg2 > 1) && (contest < 3))
{
enemyhp = (enemyhp) + (10 * diflev);
playerhp = (playerhp) + (5 * diflev);
}
if ((diflev > 1) && (dmg2 > 1) && (contest > 2))
{
enemyhp = (enemyhp) + (20 * diflev);
playerhp = (playerhp) + (5 * diflev);
}
if (dmg > 4)//10 7 6
{
...
dice1 = (rand() % 80 + cpusp2 + diflev) + 1;//was 7 now 70
...
if (bonchn == 2)
enemyhp = (enemyhp - 3 * dmg2);
if (bonchn == 3)
enemyhp = (enemyhp - 4 * dmg2);
if (bonchn >= 4)
enemyhp = (enemyhp - 5 * dmg2);
if (bonchn >= 5)
enemyhp = (enemyhp - 6 * dmg2);
printf("\n     You get a Normal Bonus!\n");
printf("     CPU HP at %d\n", enemyhp);
if (playerhp > 0)
{
++spctrbon;
...
if (new6 > 0)
printf("\n     You have a Consecutive Match Win Record!");
if ((cpulow > 0) && (new6 > 0))
printf("\n");
if (cpulow < 1)
printf("\n     You won in %d rounds with the Normal Attack!\n", ctr);
if ((((ctr < 6) && (cpulow < 1) && ((bonchn > 2) || magchn > 2))) || (((ctr < 6) && (cpulow < 1) && ((posbon > 0) || (posmag > 0)) && ((bonchn < 3) || magchn < 3))))//new
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     It's an early conclusion to the battle!\n");
if (diceQ == 2)
printf("     You outfought the opponent at a fast pace!\n");
if (diceQ == 3)
printf("     You settled the combat with efficiency!\n");
if (diceQ == 4)
printf("     You subdued the opponent with proficiency!\n");
if (((new2 < 1) && (new3 < 1) && (new6 < 1) && (ctr < 6) && (cpulow < 1) && ((bonchn > 2) || magchn > 2)))
printf("\n");
}//new
if (cpulow > 0)
{
...
if (diceQ == 5)
printf("\n     You overcame the opponent quickly!\n");
if  ((posbon < 1) && (posmag < 1))
printf("\n");
}
...
if ((posmag > 0) && (magchn < 3) && (dubon < 1) && (consecvic < 3))
{
...
else if ((posmag > 0) && (magchn < 3) && (dubon > 0) && (consecvic > 2))
{
...
printf("\n");
printf("     The fight ended with a Bonus Chain of %d!\n", bonchn);
bonrec5 = 1;
if ((new2 > 0) && (new10 > 1))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You have a new record!\n");
if (diceQ == 2)
printf("     You have a Bonus Chain Record!\n");
if (diceQ == 3)
printf("     And it's a Bonus Chain Record!\n");
}
if ((bonchn > 4) && (new2 < 1))
{
diceQ = (rand() % 3) + 1;
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("\n     It was a fantastic bout!\n\n");
if (diceQ == 2)
printf("\n     It was magnificent combat!\n\n");
if (diceQ == 3)
...
diceQ = (rand() % 2) + 1;
if (diceQ == 1)
printf("     You accumulated a Bonus Chain total of %d!\n", bonchn5);
if (diceQ == 2)
printf("     You collected a Bonus Chain total of %d!\n", bonchn5);
bonchn5 = 0;
bonrec5 = 1;
}
if (new2 > 0)
...
printf("     You had a Magic Bonus Chain of %d!\n", magchn);
if (new3 > 0)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     And that's a new record!\n");
if (diceQ == 2)
printf("     And it's a Magic Bonus Chain Record!\n");
if (diceQ == 3)
printf("     A Magic Bonus Chain Record!\n");
}
if ((magchn > 4) && (new3 > 0))
{
diceQ = (rand() % 3) + 1;
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     It was an exciting fight!\n");
if (diceQ == 2)
...
if ((dice3 > dice4) && (spmag > 2) && (spmag2 < 4) && (sumag2 != 1) && (magchn10 < 3))
{
...
if (((sumag2 > 0) && (sumag3 > 2) && (spmag2 > 3) && (dice3 > dice4) && (spmag >= 0)) || (((sumag2 > 0) && (sumag3 > 2) && ((spmag2 < 4) && (spmag7 > 0)) && (dice3 > dice4) && (spmag >= 0))))
{
enemyhp = (enemyhp - 26 * dmg2); //30 28
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     You have a Special Round Chain Record!\n");
++new1;
}
...
printf("\n");
if (new6 > 0)
printf("     And you have a Consecutive Match Win Record!\n");
...
printf("     It takes the best to be a Text Fighting Master!\n\n");
if ((ctr < 7) && (cpusp > 1) && (new6 > 0))
{
printf("     Only a Text Fighting Master could achieve this!\n\n");
}
break;
}
if ((dice3 > dice4) && (magsp4 < 1) && (spmag2 > 3) && (spmag >= 0) && (sumag2 < 1) && (magchn10 < 3))
{
enemyhp = (enemyhp - 12 * dmg2);//12 //10 12
...
if (new6 > 0)
printf("     You've got a Consecutive Match Win Record!\n");
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     And it's a Special Round Chain Record!\n");
++new1;
}
...
if ((dice3 > dice4) && (sumag2 > 0) && (spmag2 >= 0) && (spmag >= 0) && (magchn10 < 3))
{
enemyhp = (enemyhp - 18 * dmg2);//20 18
...
printf("\n");
if (new6 > 0)
printf("     You have a Consecutive Match Win Record!\n");
...
if ((new6 < 1) && (cpusp > 1) && (ctr < 8))
printf("     That was Fight Text Magic!\n");
...
if ((dice3 > dice4) && (magchn10 > 2) && (sumag10 < 1))
{
...
diceQ = (rand() % 2) + 1;
if (diceQ == 1)
printf("     You made it a piece of cake!\n");
if (diceQ == 2)
...
diceQ = (rand() % 2) + 1;
if (diceQ == 1)
printf("     You performed a nice manoeuvre!\n");
if (diceQ == 2)
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     It's a Special Round Chain Record!\n");
++new1;
}
...
printf("     The Art of Text Fighting!\n\n");
break;
}
if (dice4 > dice3)
{
...
normag = 0;
magchn = 0;
dice5 = (rand() % 33 + (diflev + cpusp2));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 29 -1 28 33
dice6 = (rand() % 30) + 1;//30-40 30 31
}
if (dice5 > dice6)
{
++consecvic2;
...
if (cpusp > 1)
printf("     You have a Special Round Chain of %d!\n", cpusp);
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1) && (new6 > 0))
printf("\n");
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     And it's a Special Round Chain Record!\n");
...
printf("     You won in Round %d with the Special Attack!\n", ctr);
if (new6 > 0)
printf("     And it's a Consecutive Match Win Record!\n");
if ((new6 < 1) && (cpusp  > 1))
printf("\n     You fought well!\n\n");
if ((new6 > 0) && (cpusp < 2))
...
if (((consecvic2 < 3) && (spctrbon < 2) || (consecvic2 < 3)) && (dice5 > dice6) && (magsp > 0) && (magsp3 < 1) && (bonchn2 < 3) && (ultsp < 4) && (spctrbon < 2))
{
printf("\n     You execute the MAGIC SPECIAL ATTACK!\n");
enemyhp = (enemyhp - 11 * dmg2);//10 12
printf("     CPU HP at %d\n", enemyhp);
++spmag2;
++spmag;
--magsp;
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You put on a great fight!\n");
if (diceQ == 2)
printf("     You fought very well!\n");
if (diceQ == 3)
...
if (diceQ == 2)
printf("     An incredible combination!\n");
if (diceQ == 3)
...
if ((spctrbon > 1) && (dice5 > dice6) && (magsp3 < 1) && (magsp >= 0) && (magsp4 < 1) && (ultsp < 4) && (bonchn2 < 3))///new bonchn2
{
enemyhp = (enemyhp - 11 * dmg2);//was 8 11 12 10
...
if (diceQ == 2)
printf("     And it's an early finish to the contest!\n");
if (diceQ == 3)
printf("     The contest ended early!\n");
}
if ((cpusp > 1) && (ctr < 6) && (new6 > 0))
...
if ((new6 > 0) && (ctr < 6) && (cpusp > 1))
printf("\n     That's sensational Text Fighting!\n\n");
break;
}
if ((consecvic2 > 2) && (dice5 > dice6) && (magsp3 < 1) && (magsp >= 0) && (bonchn2 < 3) && (ultsp < 4))
{
enemyhp = (enemyhp - 14 * dmg2); //was 11 12 14 16
...
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 > 0)))
printf("\n");
...
if (diceQ == 2)
printf("     It was a spectacular bout!\n");
if (diceQ == 3)
printf("     It was an incredible bout!\n");
}
if (((cpusp < 2) && (ctr < 6) && (new6 > 0)) || ((cpusp < 2) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr > 5) && (new6 < 1)))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You were very proficient!\n");
if (diceQ == 2)
printf("     That was really adept!\n");
if (diceQ == 3)
printf("     You were very professional!\n");
}
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp > 1) && (ctr < 6) && (new6 > 0)))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     That was extremely skilled!\n");
if (diceQ == 2)
printf("     You were amazingly skilled!\n");
if (diceQ == 3)
...
{
enemyhp = (enemyhp - 18 * dmg2);//was 8 20
...
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     That was a really great bout!\n");
if (diceQ == 2)
printf("     It was a spectacular fight!\n");
if (diceQ == 3)
printf("     That was an excellent bout!\n");
if (diceQ == 4)
printf("     It was an amazing fight!\n");
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     And the contest ended quickly!\n");
if (diceQ == 2)
printf("     And it's an early end to the contest!\n");
if (diceQ == 3)
printf("     The contest came to an early conclusion!\n");
}
if ((cpusp > 1) && (ctr < 7) && (new6 < 1))
printf("\n");
if (new6 > 0)
...
printf("     The bout ended quickly!\n");
if (diceQ == 2)
printf("     The bout came to an early conclusion!\n");
if (diceQ == 3)
printf("     The bout ended early!\n");
}
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     And it's an awesome finish!\n");
if (diceQ == 2)
printf("     And it's an amazing finish!\n");
if (diceQ == 3)
...
{
enemyhp = (enemyhp - 17 * dmg2);//was 14 16
...
if (diceQ == 3)
printf("     The contest finished in style!\n");
}
if ((new6 > 0) && (cpusp < 2) && (ctr < 7))
printf("\n");
if (ctr < 6)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     And the bout finished quickly!\n");
if (diceQ == 2)
printf("     It's a quick finish to the bout!\n");
if (diceQ == 3)
printf("     And you ended the bout early!\n");
}
if ((ctr < 7) && (ctr > 5))
{
diceQ = (rand() % 3) + 1;
...
if (diceQ == 3)
printf("     That was a very good manoeuvre!\n");
}
...
magsp4 = 0;//*THIS IS TO STOP MAGIC SP AND SPECIAL BON FROM PRINTING AT SAME TIME.
if (playerhp < 1)
printf("\n");
...
{
diceE = (rand() % 26 + diflev) + 1;//maybe 28 24 26 33 24 26 22 26
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
diceE = (rand() % 36 + diflev) + 1;//maybe 32 0r 34 32 33 30 32 36
}
if (diceR < 1)
diceS1 = (rand() % 10) + 1;//6 10 12 18 22 18
if (diceS1 == 1)
{
diceE = 0;
}
if  ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (playerhp > 0) && (emagsup < 1) && (diceS1 != 1))
{
++d;
++d2;
playerhp = (playerhp - 4 * dmg2);
...
if (diceR < 1)
diceS2 = (rand() % 20) + 1;//6 10 12 20 24 22
if ((playerhp < 1) || (emagsup > 0) || (diceS2 == 1))
{
diceF = 0;
}
else
...
diceF = (rand() % 40 + diflev) + 1; //42 40 39 38 42
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 52 + diflev) + 1; //54 52 51 50 48 52 54
}
if  ((diceF > 29) && (diceB >= 5) && (diceB <= 6) && (playerhp > 0) && (emagsup < 1) && (diceS2 != 1))
{
++e;
++e2;
...
if ((diceF > 29) && (diceR < 1))
diceS3 = (rand() % 20) + 1;//8 12 14 24 26 28
if ((playerhp < 1) || (emagsup > 0) || (diceS3 == 1))
{
diceC = 15;
}
else
...
diceC = (rand() % 84 + diflev) + 1; //72 73 74 75 78 82
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 92 + diflev) + 1; //86 87 88 92 (not 86 higher) 90
}
if  ((diceC > 47) && (diceB == 5) && (playerhp > 0) && (emagsup < 1) && (diceS3 != 1))
{
++f;
++f2;
...
if ((diceC < 48) || (diceS3 == 1))
{
ultdup = 0;
spdup = 0;
supdup2 = 0;
}
if ((diceF < 30) || (diceS2 == 1))
{
supdup = 0;
supdup2 = 0;
ultdup = 0;
}
if ((diceE < 21) || (diceS1 == 1))
{
supdup = 0;
spdup = 0;
ultdup = 0;
...
if ((enspcomb3 == 1) && (f > 0) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1) && (diceS3 != 1) && (diceS2 != 1) && (diceS1 != 1))
{
++ultdup;
if (ultdup == 1)
...
if (diceQ == 2)
printf("     A VERY SPECIAL CPU COMBINATION!\n");
if (diceQ == 3)
printf("     A SPECTACULAR CPU COMBINATION!\n");
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
if ((enspcomb1 == 1)  && (f < 1) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (diceS2 != 1) && (diceS1 != 1))
{
++supdup;
if (supdup == 1)
...
if ((enspcomb2 == 1) && (f > 0) && (e < 1) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1) && (diceS3 != 1) && (diceS1 != 1))
{
++spdup;
if (spdup == 1)
...
if ((enspcomb2 == 1)  && (f > 0) && (e > 0) && (d < 1) && ((diceC > 47) && (diceB == 5)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (diceS3 != 1) && (diceS2 != 1))
{
++supdup2;
if (supdup2 == 1)
...
{
diceM = ((rand() % 66 + 1) + (diflev + 3));///diceM was 56,70///*************DIFLEV INCREMENT MUST BE AT 3!!! AT diflev + 2 MAGIC SUPER WILL NOT ACTIVATE ON + 30 DIFLEV!!!!!!!!!!!!!
diceS = (rand() % 20) + 1;//6 8 12
if (diceS == 1)
{
diceM = 0;
diceR = 0;
}
if ((supspatt2 < 1) || (diceM < 41) || (f > 0) || (e < 1) || (d > 0))
{
magdup = 0;
}
if ((spatt2 < 1) || (diceM < 41) || (f > 0) || (e > 0) || (d < 1))
{
magdup2 = 0;
}
...
if ((diceN < 41) || (f > 0) || (e > 0) || (d > 0) || (mspatt3 < 1) || (mspatt4 < 1))
{
magdup3 = 0;
}
...
if ((diceP < 41) || (f > 0) || (e > 0) || (d > 0) || (mspatt3 < 1) || (mspatt4 < 1) || (mspatt5 < 1))
{
magdup4 = 0;
}
...
if (diceQ == 2)
printf("     A FORMIDABLE COMBINATION!\n");
if (diceQ == 3)
printf("     THE MOST POWERFUL CPU COMBO!\n");
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
{
enemyhp = (enemyhp + 3 * dmg2);//10 5
printf("     CPU executes Heal Bonus!\n");
printf("     CPU HP at %d\n\n", enemyhp);
cpmag2 = 0;
}
diceZC = (rand() % 10) + 1;
...
{
playerhp = (playerhp - 1 * dmg2);//10 5
printf("     CPU executes Magic Bonus!\n");
printf("     Player HP at %d\n\n", playerhp);
}
}
c = 0;
...
if ((ctr > 5) && (new6 < 1) && (cpusp  < 2) && (bonchn7 < 3) && (magchn5 < 3))
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     You used an effective technique!\n");
else if (diceQ == 2)
printf("     You made a well-timed manoeuvre!\n");
else if (diceQ == 3)
printf("     You outtimed the opponent perfectly!\n");
else if (diceQ == 4)
printf("     You made powerful use of technique!\n");
}
if (ctr < 6)
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     A Special Round Chain Record!\n");
++new1;
}
}
if (bonchn7 > 2)
{
printf("     You built-up a Bonus Chain of %d!\n", bonchn7);
if ((bonchn7 > 2)&& (bonchn7 > bonrec2))
bonrec = bonchn7;
if (bonrec > bonrec2)
{
++bonrec5;
...
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn7 > 2) && (magchn5 < 3))
printf("\n");
if ((cpusp < 2) && ((ctr < 6) && (new6 < 1)) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 > 0) || (new3 > 0)))
printf("\n");
if (magchn5 > 2)
printf("     You had a Magic Bonus Chain of %d!\n", magchn5);
if (magchn5 > 2)
...
if ((cpusp < 2) && ((ctr > 5) && (new6 < 1)) && (bonchn7 > 2) && (magchn5 > 2) &&  ((new2 > 0) && (new3 > 0)))
printf("\n");
if ((cpusp < 2) && ((ctr < 6) && (new6 > 0)) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 > 0) || (new3 > 0)))
printf("\n");
if ((cpusp < 2) && ((ctr > 5) && (new6 > 0)) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 > 0) || (new3 > 0)))
printf("\n");
if (new3 > 0)
{
printf("     It's a Magic Bonus Chain Record!\n");
new8 = 1;
}
if ((cpusp > 1) && (ctr < 6) && (new6 > 0) && (bonchn7 < 3) && (magchn5 < 3))
printf("\n");
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 < 1) && (new3 < 1)))
printf("\n");
if (new6 > 0)
{
diceQ2 = (rand() % 2) + 1;
...
if (diceQ2 = 1)
{
printf("\n     It was a fantastic defence!\n\n");
}
else if (diceQ2 = 2)
{
printf("\n     That was very skilled!\n\n");
}
else if (diceQ2 = 3)
{
printf("\n     That was good combat!\n\n");
}
else if (diceQ2 = 4)
{
printf("\n     You were on form!\n\n");
...
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     You used an excellent finishing move!\n");
else if (diceQ == 2)
printf("     An exciting end to the fight!\n");
else if (diceQ == 3)
printf("     A nice conclusion to the fight!\n");
else if (diceQ == 4)
printf("     You fought convincingly to the finish!\n");
}
if (ctr < 6)
printf("     You took victory early in the contest!\n");
if (new6 > 0)
printf("     You have a Consecutive Match Win Record!\n");
if ((magrec2 < 3) && (magchn5 > 2))
magrec2 = magchn5;
if ((bonrec2 < 3) && (bonchn7 > 2))
bonrec2 = bonchn7;
if (bonchn7 > 2)
{
printf("     You accumulated a Bonus Chain of %d!\n", bonchn7);
if ((bonchn7 > 2)&& (bonchn7 > bonrec2))
bonrec = bonchn7;
if (bonrec > bonrec2)
{
...
if ((cpusp < 2) && ((ctr < 6) || (new6 > 0)) && ((bonchn7 > 2) && (magchn5 < 3))  &&  ((new2 > 0) && (new3 < 1)))
printf("\n");
if ((cpusp < 2) && ((ctr < 6) || (new6 > 0)) && ((bonchn7 < 3) && (magchn5 > 2))  &&  ((new2 < 1) && (new3 > 0)))
printf("\n");
if ((new2 > 0) && (new10 > 1))
{
printf("     You have a Bonus Chain Record!\n");
...
if ((cpusp < 2) && (ctr < 6) && (new6 < 1) && (bonchn7 > 2) && (magchn5 > 2))
printf("\n");
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 < 1) && (new3 < 1)))
printf("\n");
if ((cpusp < 2) && (ctr > 5) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2) && ((new2 < 1) && (new3 < 1))) ///ctr??
printf("\n");
if ((cpusp < 2) && ((ctr < 6) || (new6 > 0)) && (bonchn7 > 2) && (magchn5 > 2) &&  ((new2 > 0) || (new3 > 0)))
printf("\n");
if (magchn5 > 2)
...
{
printf("\n     That was good counter-fighting!\n\n");
}
}
if (((new6 > 0) && (cpusp > 1) && (ctr > 5)) || ((ctr < 6) && (new6 > 0) && (cpusp  > 1)))
{
...
{
printf("\n     It was an outstanding manoeuvre!\n\n");
}
}
break;
}
...
{
diceQ = (rand() % 61) + 1;//12 24 32 38 40 61
...
diceQ1 = (rand() % 65) + 1;//14 16 32 38 42 44 48 70 66 55
if (((diceQ > 15) && (diceQ1 < 17) && (diceQ1 > 1)) || ((diceQ1 > 1) && (diceQ1 < 17) && ((diceQ == 5) || (diceQ == 13))  && (ctr < 9)) || ((diceQ1 > 1) && (diceQ1 < 17) && (diceQ == 12) && (ctr < 5)))
printf("\n");
if (((diceQ > 15) && (diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1)) || ((diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1)) && ((diceQ == 13) && (ctr < 9)))
printf("\n");
if (((diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1)) && ((diceQ == 12) && (ctr < 5)) || ((diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1)) && ((diceQ == 5) && (ctr < 9)))
printf("\n");
if ((diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1))
...
emagsup = 0;
emagsup5 = 0;
diceT = (rand() % 100) + 1;//100
if (diceT == 1)
{
emagsup = 1;
emagsup5 = 0;
}
diceT = (rand() % 200) + 1;//100
if (diceT == 1)
{
emagsup = 1;
emagsup5 = 1;
...
if ((diflev > 1) && (dmg2 > 1) && (contest == 4))
{
enemyhp = (enemyhp) + (25 * diflev);
playerhp = (playerhp) + (10 * diflev);
}
} while (contest != 5);
if ((dmg2 < 2) && (dmg < 4))
{
